...
export interface ApiDevopsArticleDevopsArticle
  extends Struct.CollectionTypeSchema {
  collectionName: 'devops_articles';
  info: {
    description: '';
    displayName: 'Devops Article';
    pluralName: 'devops-articles';
    singularName: 'devops-article';
  };
  options: {
  ...
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::devops-article.devops-article'
    > &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
    Score: Schema.Attribute.Boolean;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
  };
